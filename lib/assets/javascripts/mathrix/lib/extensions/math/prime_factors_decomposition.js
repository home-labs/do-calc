    ...
    var
        Iterator_ = function(collection) {
            ...
            this.next = function() {
                ...
                // pode ser retornado um objeto Map associando remains primeFactor. E ainda os Maps poderiam ser indexados por um índice numérico de iteração (array de Maps)
                return remains;
            };
